...
class _BuyScreenState extends State<BuyScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _handleSubmit() async {
    ...
    if (_budgetController.text.trim().isNotEmpty &&
        !_validateNumeric(_budgetController.text)) {
      _showToast('PLEASE_ENTER_NUMBERS_ONLY'.tr(context));
      return;
    }
          ...
          children: [
            SingleChildScrollView(
              ...
              child: VisibilityDetector(
                key: const Key('buy-content-section'),
