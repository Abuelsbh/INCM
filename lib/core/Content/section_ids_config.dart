    ...
    switch (pageId) {
      case 'corporate-leasing':
        return [
          ...
          SectionIdOption('background-image', 'الصورة الخلفية (ويب / افتراضي)', 'image'),
          SectionIdOption('background-image-mobile', 'الصورة الخلفية (موبايل — اختياري)', 'image'),
          SectionIdOption('home-carousel-image', 'صورة كاروسيل الصفحة الرئيسية (بطاقة الخدمة)', 'image'),
      ...
      case 'medical-leasing':
        return [
          ...
          SectionIdOption('background-image', 'Background Image (web / default)', 'image'),
          SectionIdOption('background-image-mobile', 'Background Image (mobile — optional)', 'image'),
          SectionIdOption('home-carousel-image', 'Home carousel card image (Explore services)', 'image'),
      ...
      case 'services':
        return [
          ...
          SectionIdOption('services-background', 'خلفية قسم الخدمات (ويب / افتراضي)', 'image'),
          SectionIdOption('services-background-mobile', 'خلفية قسم الخدمات (موبايل — اختياري)', 'image'),
        ];
      ...
      default:
        ...
        return [
          ...
          SectionIdOption('background-image', 'صورة الخلفية (ويب / افتراضي)', 'image'),
          SectionIdOption('background-image-mobile', 'صورة الخلفية (موبايل — اختياري)', 'image'),
        ];
    }
  }
}
